...
<title>Pure Nature - Tea Tree Serum | Official Store</title>
 <style> body { font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; margin: 0; padding: 0; background: #0b0f0d; color: white; text-align: center; line-height: 1.6; }
.banner { background: #d90429; color: white; padding: 12px; font-weight: bold; font-size: 16px; position: sticky; top: 0; z-index: 1000; }
...
<body>
 ...
 <header><h2 style="margin:0;">PURE NATURE SKINCARE</h2></header>
    <div class="container">        
        <div class="trust-banner">🏆 50,000+ Verified Happy Customers</div>
<div class="stock-container">
            <span style="font-size: 15px; color: #ff4d4d; font-weight: 900; text-transform: uppercase;">Stock Status: Only 2 Units Left!</span>
